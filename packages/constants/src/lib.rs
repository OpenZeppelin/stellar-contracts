...
pub const OWNERSHIP_BUCKET_EXTEND_AMOUNT: u32 = 30 * DAY_IN_LEDGERS;
pub const OWNERSHIP_BUCKET_TTL_THRESHOLD: u32 = OWNERSHIP_BUCKET_EXTEND_AMOUNT - DAY_IN_LEDGERS;
