...
//         Base::set_metadata(e, 18, String::from_str(e, "Asset Token"), String::from_str(e, "ASSET"));
//     }
...
//         Base::set_metadata(e, 18, String::from_str(e, "Vault Token"), String::from_str(e, "vTKN"));
...
// fn create_vault_client<'a>(e: &Env, asset_address: &Address) -> VaultContractClient<'a> {
//     let address = e.register(VaultContract, (asset_address,));
//     let client = VaultContractClient::new(e, &address);
//     client
// }
