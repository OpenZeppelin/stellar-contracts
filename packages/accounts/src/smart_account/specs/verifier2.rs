...
pub static mut VERIFIER2_VERIFY_RESULT_MAP: GhostMap<(Bytes, BytesN<32>, BytesN<64>), bool> = GhostMap::UnInit;
impl Verifier for Verifier2 {
    ...
    fn verify(
        ...
        unsafe {
            VERIFIER2_VERIFY_RESULT_MAP.get(&(hash, key_data, sig_data))
        }
    }
}
