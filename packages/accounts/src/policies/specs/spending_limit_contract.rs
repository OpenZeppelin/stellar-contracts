...
use crate::{
    policies::{
        spending_limit,
        spending_limit::{SpendingLimitAccountParams, SpendingLimitData},
        Policy,
    },
...
impl SpendingLimitPolicy {
    ...
    pub fn set_spending_limit(
        ...
        crate::policies::spending_limit::set_spending_limit(
            e,
            spending_limit,
            &context_rule,
            &smart_account,
...
// contract functions in the same crate.
impl Policy for SpendingLimitPolicy {
    ...
    fn can_enforce(
        ...
        crate::policies::spending_limit::can_enforce(
            e,
            &context,
    ...
    fn enforce(
        ...
        crate::policies::spending_limit::enforce(
            e,
            &context,
            &authenticated_signers,
            &context_rule,
