...
pub fn get_simple_threshold_sanity(e: Env) {
    ...
    let _ = SimpleThresholdPolicy::get_threshold(&e, ctx_rule_id, account_id);
    cvlr_satisfy!(true);
}
...
pub fn set_simple_threshold_sanity(e: Env) {
    ...
    let ctx_rule: ContextRule = ContextRule::nondet();
    let account_id = nondet_address();
    SimpleThresholdPolicy::set_threshold(&e, threshold, ctx_rule, account_id);
    cvlr_satisfy!(true);
}
...
pub fn install_simple_threshold_sanity(e: Env) {
    ...
    let ctx_rule: ContextRule = ContextRule::nondet();
    let account_id = nondet_address();
    SimpleThresholdPolicy::install(&e, params, ctx_rule, account_id);
    cvlr_satisfy!(true);
}
...
pub fn uninstall_simple_threshold_sanity(e: Env) {
    let ctx_rule: ContextRule = ContextRule::nondet();
    let account_id = nondet_address();
    SimpleThresholdPolicy::uninstall(&e, ctx_rule, account_id);
    cvlr_satisfy!(true);
}
