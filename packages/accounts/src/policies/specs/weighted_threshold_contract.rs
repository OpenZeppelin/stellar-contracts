...
impl WeightedThresholdPolicy {
    ...
    pub fn set_threshold(
        ...
        crate::policies::weighted_threshold::set_threshold(
            e,
            threshold,
            &context_rule,
            &smart_account,
...
impl Policy for WeightedThresholdPolicy {
    ...
    fn can_enforce(
        ...
        crate::policies::weighted_threshold::can_enforce(
            e,
            &context,
    ...
    fn enforce(
        ...
        crate::policies::weighted_threshold::enforce(
            e,
            &context,
            &authenticated_signers,
            &context_rule,
    ...
    fn install(
        ...
        crate::policies::weighted_threshold::install(
            e,
            &install_params,
            &context_rule,
            &smart_account,
