...
$$s\_{a,r} = \text{ECDH}(r\_e, K\_{\text{aud,r}}) \qquad \text{(Elliptic Curve Diffie-Hellman)}$$
...
$$s\_{a,s} = \text{ECDH}(r\_e, K\_{\text{aud,s}}) \qquad \text{(Elliptic Curve Diffie-Hellman)}$$
