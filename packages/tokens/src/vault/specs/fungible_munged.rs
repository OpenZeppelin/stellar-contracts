...
impl Base {
    ...
    pub fn total_supply_munged(e: &Env) -> i128 {
    ...
    pub fn balance_munged(e: &Env, account: &Address) -> i128 {
    ...
    pub fn allowance_munged(e: &Env, owner: &Address, spender: &Address) -> i128 {
    ...
    pub fn spend_allowance_munged(e: &Env, owner: &Address, spender: &Address, amount: i128) {
        if amount < 0 {
            panic_with_error!(e, FungibleTokenError::LessThanZero)
        }
    ...
    pub fn transfer_munged(e: &Env, from: &Address, to: &Address, amount: i128) {
        from.require_auth();
    ...
    pub fn transfer_from_munged(e: &Env, spender: &Address, from: &Address, to: &Address, amount: i128) {
    ...
    /// This function does not enforce authorization. Ensure that authorization
    /// is handled at a higher level.
    pub fn update_munged(e: &Env, from: Option<&Address>, to: Option<&Address>, amount: i128) {
        if amount < 0 {
            panic_with_error!(e, FungibleTokenError::LessThanZero);
        }
    ...
    /// admin.require_auth();
    /// ```
    pub fn mint_munged(e: &Env, to: &Address, amount: i128) {
