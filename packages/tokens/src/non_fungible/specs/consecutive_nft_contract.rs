...
use crate::non_fungible::{ContractOverrides, NonFungibleToken, burnable::NonFungibleBurnable, consecutive::{Consecutive, NonFungibleConsecutive}};
...
// TODO: This is just a basic call to batch_mint. May need additional setup depending on rule.
impl ConsecutiveNft {
